...
const TOUR_STEPS = [
  {
    ...
    title: 'Job Info',
    body: 'Start here. Fill in the job title, employer, and posting URL — or click Scan job page to pull these details automatically from the current tab.',
  },
  {
    target: '#card-job-desc',
    title: 'Job Description',
    body: 'When you scan a job page, the description fills automatically. If it didn\'t pull through, paste it here manually — the more complete the text, the more precisely the AI tailors your drafts.',
  },
  {
    target: '#btn-ai-fit-check',
    title: 'AI Fit Check',
    body: 'After scanning a page, run AI Fit Check to get a score and summary of how well your profile matches the role — without leaving the dashboard.',
  },
  {
    target: '#card-generate',
    title: 'Generate',
    body: 'Choose cover letter length and writing tone, then generate a tailored resume, cover letter, or both. A Stop button appears while the AI is working.',
  },
  {
    target: '#card-drafts',
    title: 'Preview',
    body: 'Your tailored documents appear here. Switch tabs to review each draft and use Edit in the preview for final wording changes before exporting.',
  },
  {
    target: '#appearance-controls',
    title: 'Appearance',
    body: 'Change template, accent colour, and spacing without regenerating. These controls update the rendered document instantly.',
  },
  {
  ...
  },
  {
    target: '#card-ats',
    title: 'ATS Check',
    body: 'Scan the job description for keywords your resume may be missing. Matched and missing terms appear as chips you can send directly to Refine.',
  },
  {
    target: '#card-save',
    title: 'Export & email',
    body: 'Open the browser\'s print dialog and choose Save as PDF to export. You can also prepare a drafted application email from the same card.',
  },
  {
    target: '#card-application-form',
    title: 'Application Autofill',
    body: 'An optional helper for application forms with repetitive fields. It scans the live form, matches your profile, and always asks you to review before filling anything.',
  },
  {
    target: '#btn-chat',
    title: 'Job Chat',
    body: 'Discuss this job with AI — strategy, gaps, how to angle your resume, or whether to apply. The AI has access to your profile and the job description.',
  },
  {
    target: '#btn-jobs',
    title: 'Jobs',
    body: 'Open the Saved Jobs queue to track application status. Use the Recent tab to reload any previous export and regenerate tailored documents.',
  },
  {
    target: '#profile-strip',
    title: 'Profile Select',
    body: 'Switch the profile the AI uses for this application. Profiles let you keep separate sets of personal details for different roles or career directions.',
  },
  {
    target: '#btn-open-profile',
    title: 'My Profile',
    body: 'Edit the personal details the AI uses to write your documents — name, contact info, work history, skills, and more.',
  },
  {
    target: '#btn-open-full-page',
    title: 'Full Page',
    body: 'Open the workspace in a full browser tab for more screen space. Your current job context carries over automatically. Unlocks after generating a draft.',
  },
  {
    target: '#btn-settings',
    title: 'Settings',
    body: 'Configure your AI provider, document defaults, and file naming preferences. Saving AI provider settings unlocks draft generation.',
  },
];
